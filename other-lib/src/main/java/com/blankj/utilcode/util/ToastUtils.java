...
public final class ToastUtils {
    ...
    public static void setMsgSize(final int msgSize) {
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                ...
                tvMessage.setPadding(SizeUtils.dp2px(16), 0, SizeUtils.dp2px(16), 0);
                if(msgSize > 0) {
                    tvMessage.setTextSize(TypedValue.COMPLEX_UNIT_PX, msgSize);
                }
